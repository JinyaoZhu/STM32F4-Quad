...
*********************************************************************************************************
*/
#define COMM_PACKET_BUF_LEN  21 /* packet length from uart2 */
/*
*********************************************************
*                   LOGIC ANALYSIS
*********************************************************
*/
#define LOGIC_DBG_PIN1 GPIO_Pin_15
#define LOGIC_DBG_PIN2 GPIO_Pin_8
#define LOGIC_DBG_PORT GPIOB

#define LOGIC_DBG_PIN1_H     GPIO_SetBits(LOGIC_DBG_PORT, LOGIC_DBG_PIN1)
#define LOGIC_DBG_PIN2_H     GPIO_SetBits(LOGIC_DBG_PORT, LOGIC_DBG_PIN2)
#define LOGIC_DBG_PIN1_L     GPIO_ResetBits(LOGIC_DBG_PORT, LOGIC_DBG_PIN1)
#define LOGIC_DBG_PIN2_L     GPIO_ResetBits(LOGIC_DBG_PORT, LOGIC_DBG_PIN2)


/*
*********************************************************************************************************
*                                        INT PRIORITY DEFINES
*********************************************************************************************************
*/

#define BSP_INT_ID_EXTI0_PRIO     5 /* MPU6000 */
#define BSP_INT_SONAR_IQR_PRIO    6
#define BSP_INT_ID_TIM1_CC_PRIO   7
#define BSP_INT_ID_TIM2_PRIO      7
#define BSP_INT_ID_TIM8_CC_PRIO   7
#define BSP_INT_ID_USART2_PRIO    8
#define BSP_INT_ID_EXTI1_PRIO     8 /* HMC5883L */
#define BSP_INT_ID_USART1_PRIO    10
