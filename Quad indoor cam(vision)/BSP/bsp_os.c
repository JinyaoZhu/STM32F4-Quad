...
*                                          BSP_OS_SemSet()
*
* Description : Set a semaphore count
*
* Argument(s) : sem          Semaphore handler
*
* Return(s)   : DEF_OK        
...
*                                      BSP_OS_MutexCreate()
*
* Description : Creates a mutex to lock/unlock
*
* Argument(s) : p_mutex        Pointer to a BSP_OS_SEM structure
*
*               p_mutex_name   Pointer to the mutex name.
*
...
*                                     BSP_OS_MutexWait()
*
* Description : Wait on a mutex to become available
*
* Argument(s) : mutex        mutex handler
*
